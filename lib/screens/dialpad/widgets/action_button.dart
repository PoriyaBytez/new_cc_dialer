      ...
      children: <Widget>[
        GestureDetector(
            ...
            child: RawMaterialButton(
              ...
              splashColor: widget.fillColor ?? (widget.checked! ? const Color(0xffdcdcdc ): Colors.blue),
              fillColor: widget.fillColor ?? (widget.checked! ? Colors.blue : const Color(0xffdcdcdc )),
              elevation: 8.0,
